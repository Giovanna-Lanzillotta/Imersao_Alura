...
document.getElementById("botaoComecar").onclick = function() {
document.querySelector(".inicio").style.display = "none"; // Esconde o botão de começar
document.querySelector(".conteudo").style.display = "block"; // Mostra o conteúdo do quiz
